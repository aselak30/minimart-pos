...
public class Product {
    ...
    private BigDecimal damagedQuantity; // New field
    ...
    public void setStockQuantity(BigDecimal q) {
    ...
    public void setDamagedQuantity(BigDecimal q) {
        this.damagedQuantity = q;
    }
