...
public class UserService {
    ...
    public boolean updateUser(User user) {
        ...
        if (ok)
            auditService.log("USER_UPDATE", "users", user.getId(),
    ...
    public boolean setActive(int userId, boolean active) {
        ...
        if (ok)
            auditService.log(active ? "USER_ENABLE" : "USER_DISABLE", "users", userId, null, null);
        return ok;
    }
    ...
    public void adminResetPassword(int userId, String newPassword) {
        ...
        auditService.log("PASSWORD_CHANGE_ADMIN", "users", userId, null, "admin forced password change");
    }
